    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                            ...
                            <tr style="background-color: #f9f9f9; transition: background-color 0.3s ease;">
                                ...
                                <td style="text-align: center; padding: 12px; border-bottom: 1px solid #ddd;">
                                    <div style="display: flex; justify-content: space-around;">
                                        <a href="{{ url('editar/' . $animal['id_animal']) }}" style="padding: 8px 12px; background-color: #FFC107; color: white; text-decoration: none; border-radius: 5px; font-size: 14px;">Editar</a>
                ...
                <a href="{{ url('/adicionar') }}" style="display: inline-block; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 5px; font-size: 14px; width: 100%; margin-top: 20px; text-align: center;">
                    Adicionar Animal
                </a>
            </div>
        </div>
